...
describe("DataTableUtils", () => {
    ...
    describe('Join Operations', () => {
        ...
        describe('RightJoin', () => {
            ...
            it('should handle right table with no matches', async () => {
                ...
                expect(await result.Rows()).toEqual([
                    { dept_id: 999, dept_name: 'No Match Dept' }
                ]);
            });
    ...
    describe('SyncReport', () => {
        ...
        it('should throw an error when calling SyncReport with DataTables with different field names', async () => {
            ...
            await expect(DataTableUtils.SyncReport({
                source: sourceData,
                destination: destinationData,
                on: "identifier"
            }))
        ...
        it('Case: Sync from Memory to Postgres', async () => {
            const sourceData = new DataTable("Source", [
                { memid: 0, surname: "GUEST", firstname: "GUEST", address: "XXXXXXXXXX", zipcode: 0, telephone: "(000) 000-0000", recommendedby: null, joindate: new Date("2012-06-30T22:00:00.000Z") },
                { memid: 1, surname: "Smith", firstname: "Darren", address: "XXXXXXXXXX", zipcode: 4321, telephone: "555-555-5555", recommendedby: null, joindate: new Date("2012-07-02T10:02:05.000Z") },
                { memid: 2, surname: "Smith", firstname: "Tracy", address: "XXXXXXXXXX", zipcode: 4321, telephone: "555-555-5555", recommendedby: null, joindate: new Date("2012-07-02T10:08:23.000Z") },
                { memid: 3, surname: "Rownam", firstname: "Tim", address: "XXXXXXXXXX", zipcode: 23423, telephone: "(844) 693-0723", recommendedby: null, joindate: new Date("2012-07-03T07:32:15.000Z") },
                { memid: 4, surname: "Joplette", firstname: "Janice", address: "20 Crossing Road, New York", zipcode: 234, telephone: "(833) 942-4710", recommendedby: 1, joindate: new Date("2012-07-03T08:25:05.000Z") },
                { memid: 6, surname: "toadd", firstname: "ADD", address: "where", zipcode: 234, telephone: "(833) 942-4710", recommendedby: 1, joindate: new Date("2012-07-03T08:25:05.000Z") }
            ])

            const destinationData = new DataTable("Destination", [
                { memid: 0, surname: "GUEST", firstname: "GUEST", address: "GUEST", zipcode: 0, telephone: "(000) 000-0000", recommendedby: null, joindate: new Date("2012-06-30T22:00:00.000Z") },
                { memid: 1, surname: "Smith", firstname: "Darren", address: "8 Bloomsbury Close, Boston", zipcode: 4321, telephone: "555-555-5555", recommendedby: null, joindate: new Date("2012-07-02T10:02:05.000Z") },
                { memid: 2, surname: "Smith", firstname: "Tracy", address: "8 Bloomsbury Close, New York", zipcode: 4321, telephone: "555-555-5555", recommendedby: null, joindate: new Date("2012-07-02T10:08:23.000Z") },
                { memid: 3, surname: "Rownam", firstname: "Tim", address: "23 Highway Way, Boston", zipcode: 23423, telephone: "(844) 693-0723", recommendedby: null, joindate: new Date("2012-07-03T07:32:15.000Z") },
                { memid: 4, surname: "Joplette", firstname: "Janice", address: "20 Crossing Road, New York", zipcode: 234, telephone: "(833) 942-4710", recommendedby: 1, joindate: new Date("2012-07-03T08:25:05.000Z") },
                { memid: 5, surname: "todelete", firstname: "DELETE", address: "nowhere", zipcode: 234, telephone: "(833) 942-4710", recommendedby: 1, joindate: new Date("2012-07-03T08:25:05.000Z") }
            ])
    ...
    describe('RemoveDuplicates', () => {
        ...
        it('should remove duplicate rows based on specified fields using hash method', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id', 'name'], REMOVE_DUPLICATES_METHOD.HASH, REMOVE_DUPLICATES_STRATEGY.FIRST)
            expect(await result.Rows()).toEqual([
                { id: 1, name: 'Alice', age: 30, value: 10 },
                { id: 1, name: 'alice', age: 30 },
                { id: 2, name: 'Bob', age: 25, value: 20 },
        ...
        it('should keep the last occurrence of duplicate rows when strategy is last', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id', 'name'], REMOVE_DUPLICATES_METHOD.EXACT, REMOVE_DUPLICATES_STRATEGY.LAST)
        ...
        it('should replace first occurrence with last occurrence when strategy is last', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id'], REMOVE_DUPLICATES_METHOD.HASH, REMOVE_DUPLICATES_STRATEGY.LAST)
        ...
        it('should replace first occurrence with row having maximum condition value when strategy is max', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id'], REMOVE_DUPLICATES_METHOD.HASH, REMOVE_DUPLICATES_STRATEGY.HIGHEST, 'value')
        ...
        it('should replace first occurrence with row having minimum condition value when strategy is min', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['name'], REMOVE_DUPLICATES_METHOD.HASH, REMOVE_DUPLICATES_STRATEGY.LOWEST, 'age')
        ...
        it('should handle empty fields array gracefully when calling RemoveDuplicates', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, [], REMOVE_DUPLICATES_METHOD.HASH, REMOVE_DUPLICATES_STRATEGY.FIRST)
        ...
        it('should handle invalid JSON structure in rows when calling RemoveDuplicates', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id'], REMOVE_DUPLICATES_METHOD.HASH, REMOVE_DUPLICATES_STRATEGY.FIRST, '')
        ...
        it('should handle invalid condition path in rows when calling RemoveDuplicates', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id'], REMOVE_DUPLICATES_METHOD.HASH, REMOVE_DUPLICATES_STRATEGY.FIRST, 'invalidField')
            // Assertion
            expect(await result.Rows()).toEqual([
                { id: 1, name: 'Alice', age: 30, value: 10 },
                { id: 2, name: 'Bob', age: 25, value: 20 },
        ...
        it('should handle rows with non-string values in specified fields when calling RemoveDuplicates method and condition', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id'], REMOVE_DUPLICATES_METHOD.HASH, REMOVE_DUPLICATES_STRATEGY.HIGHEST, 'age')
            // Assertion
            expect(await result.Rows()).toEqual([
                { id: 1, name: 'Alice', age: 30, value: 10 },
                { id: 2, name: 'Bob', age: 25, value: 20 },
        ...
        it('should remove duplicate rows based on specified fields using ignorecase method', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id', 'name'], REMOVE_DUPLICATES_METHOD.IGNORE_CASE, REMOVE_DUPLICATES_STRATEGY.LOWEST, 'age')
            expect(await result.Rows()).toEqual([
                { id: 1, name: 'Alice', age: 15, value: null },
                { id: 2, name: 'Bob', age: true, value: 15 },
                { id: 3, name: 'Jane', age: 10, value: true },
        ...
        it('should remove duplicate rows based on custom strategy', async () => {
            const result = await DataTableUtils.RemoveDuplicates(dtDuplicates, ['id', 'name'], REMOVE_DUPLICATES_METHOD.IGNORE_CASE, REMOVE_DUPLICATES_STRATEGY.CUSTOM, 'age > 10 AND value > 0')
            expect(await result.Rows()).toEqual([
                { id: 1, name: 'Alice', age: 30, value: 10 },
                { id: 2, name: 'Bob', age: 25, value: 20 },
                { id: 3, name: 'Jane', age: 10, value: true },
    ...
    describe('SetFromDataTable', () => {
        it('should copy all data from source to target using DuckDB COPY', async () => {
            ...
            expect(targetRows).toEqual(expect.arrayContaining([
