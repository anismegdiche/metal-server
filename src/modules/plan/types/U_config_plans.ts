...
//
export const z_U_config_plans_plan_entity_steps = z.array(z_U_config_plans_plan_entity_step)
...
export const z_U_config_plans = z.record(z.string("Plan name is required").describe("planName"), z_U_config_plans_plan)
