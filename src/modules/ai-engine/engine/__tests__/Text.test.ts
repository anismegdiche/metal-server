...
describe('Text', () => {
    ...
    describe('ParaphraseDetection', () => {
        ...
        it('should detect paraphrase', async () => {
            ...
            expect(result).toEqual(expect.objectContaining({
                ...
                target_sentence: expect.any(String),
            ...
            spyAxios.mockImplementationOnce(() => {
                return Promise.resolve({
                    data: {
                        result: [
                            {
                                generated_text: "The capital of France is Paris, a beautiful city known for its iconic Eiffel Tower and rich cultural heritage."
                            }
                        ]
                    }
                });
    ...
    describe('TokenClassification', () => {
        it('should perform token classification', async () => {
            ...
            const result = await text.TokenClassification(<TAiRunArguments>{
