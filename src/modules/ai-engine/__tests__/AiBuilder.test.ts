...
vi.mock('../AiDocker');
vi.mock('../engine/Ocr', () => ({ Ocr: class { Prepare() { return Promise.resolve(); } AiDockerService = {} } }));
vi.mock('../engine/Text', () => ({ Text: class { Prepare() { return Promise.resolve(); } AiDockerService = {} } }));
vi.mock('../engine/Image', () => ({ Image: class { Prepare() { return Promise.resolve(); } AiDockerService = {} } }));
vi.mock('../engine/Audio', () => ({ Audio: class { Prepare() { return Promise.resolve(); } AiDockerService = {} } }));
