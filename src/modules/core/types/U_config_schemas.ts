...
export const z_U_config_schemas_schema = z
	.union([
		z.object({
			source: z.string(),
			entities: z.record(z.string(), z_U_config_schemas_schema_entities_entity).optional(),
		}),
		z.object({
			source: z.string().optional(),
			entities: z.record(z.string(), z_U_config_schemas_schema_entities_entity),
		}),
	])
	.and(
		z.object({
