...
class TestProvider extends absDataProvider {
    ...
    async ListEntities(_schemaRequest: { schema: string; source?: string }): Promise<TInternalResponse<{ schema: string; status: HTTP_STATUS_CODE.OK; data: DataTable; entity?: string }>> {
        const data = {} as unknown as DataTable
        return { StatusCode: HTTP_STATUS_CODE.OK, Body: { schema: 's', status: HTTP_STATUS_CODE.OK, data } }
    }
    async AddEntity(_schemaRequest: { schema: string; source?: string } | { schema: string; entity: string; source?: string }): Promise<TInternalResponse<undefined>> {
        return { StatusCode: HTTP_STATUS_CODE.OK, Body: undefined }
    }
    async Select(_schemaRequest: { schema: string; entity: string; source?: string }): Promise<TInternalResponse<{ schema: string; status: HTTP_STATUS_CODE.OK; data: DataTable; entity?: string }>> {
        const data = {} as unknown as DataTable
        return { StatusCode: HTTP_STATUS_CODE.OK, Body: { schema: 's', status: HTTP_STATUS_CODE.OK, data } }
    }
    async Insert(_schemaRequest: { schema: string; entity: string; source?: string }): Promise<TInternalResponse<undefined>> { return { StatusCode: HTTP_STATUS_CODE.OK, Body: undefined } }
    async Update(_schemaRequest: { schema: string; entity: string; source?: string }): Promise<TInternalResponse<undefined>> { return { StatusCode: HTTP_STATUS_CODE.OK, Body: undefined } }
    async Delete(_schemaRequest: { schema: string; entity: string; source?: string }): Promise<TInternalResponse<undefined>> { return { StatusCode: HTTP_STATUS_CODE.OK, Body: undefined } }
    EscapeEntity(entity: string): string { return `"${entity}"` }
