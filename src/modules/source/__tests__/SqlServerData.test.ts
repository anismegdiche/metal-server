...
describe("SqlServerData", () => {
	...
	describe("Init", () => {
		...
		it("should throw error when source name is empty", async () => {
			await expect(sqlServerData.Init("", mockConfig)).rejects.toThrow()
		})
		...
		it("should throw error when source name is null", async () => {
			await expect(sqlServerData.Init(null as unknown as string, mockConfig)).rejects.toThrow()
		})
	...
	describe("Select", () => {
		...
		it("should throw error when connection is not established", async () => {
			...
			await expect(sqlServerData.Select(mockSelectRequest)).rejects.toThrow(HttpErrorInternalServerError)
		})
	...
	describe("Insert", () => {
		...
		it("should throw error when data is missing", async () => {
			...
			await expect(sqlServerData.Insert(mockInsertRequest)).rejects.toThrow(HttpErrorBadRequest)
		})
		...
		it("should throw error when connection is not established", async () => {
			...
			await expect(sqlServerData.Insert(mockInsertRequest)).rejects.toThrow(HttpErrorInternalServerError)
		})
	...
	describe("Update", () => {
		...
		it("should throw error when data is missing", async () => {
			...
			await expect(sqlServerData.Update(mockUpdateRequest)).rejects.toThrow(HttpErrorBadRequest)
		})
		...
		it("should throw error when connection is not established", async () => {
			...
			await expect(sqlServerData.Update(mockUpdateRequest)).rejects.toThrow(HttpErrorInternalServerError)
		})
	...
	describe("Delete", () => {
		...
		it("should throw error when connection is not established", async () => {
			...
			await expect(sqlServerData.Delete(mockDeleteRequest)).rejects.toThrow(HttpErrorInternalServerError)
		})
	...
	describe("ListEntities", () => {
		...
		it("should throw error when entities not found", async () => {
			...
			await expect(sqlServerData.ListEntities(mockListRequest)).rejects.toThrow(HttpErrorNotFound)
		})
		...
		it("should throw error when connection is not established", async () => {
			...
			await expect(sqlServerData.ListEntities(mockListRequest)).rejects.toThrow(HttpErrorInternalServerError)
		})
	...
	describe("Error Handling", () => {
		it("should handle query error", async () => {
			...
			await expect(sqlServerData.Select(mockSchemaRequest)).rejects.toThrow(HttpErrorInternalServerError)
		})
	})
})
