...
describe('JsonHelper', () => {
    ...
    describe('Get', () => {
        ...
        it('should return nested value when valid path is provided', () => {
            ...
            const result = JsonHelper.Get<string>(json, 'user.name')
        ...
        it('should return entire JSON object when path is undefined', () => {
            ...
            const result = JsonHelper.Get<TJson>(json)
        ...
        it('should return default value when path does not exist', () => {
            ...
            const result = JsonHelper.Get<string>(json, 'user.email', 'default@email.com')
        ...
        it('should handle deeply nested objects with dot notation', () => {
            ...
            const result = JsonHelper.Get<string>(json, 'a.b.c.d')
        ...
        it('should type cast returned value to specified generic type', () => {
            const json = { count: '42' }
            const result = JsonHelper.Get<number>(json, 'count')
        ...
        it('should handle empty JSON object input', () => {
            const json = {}
            const result = JsonHelper.Get<any>(json, 'prop', 'default')
        ...
        it('should return undefined when default value is undefined', () => {
            const json = { user: {} }
            const result = JsonHelper.Get<string>(json, 'user.name', undefined)
        ...
        it('should handle invalid jsonPath format gracefully', () => {
            ...
            const result = JsonHelper.Get<string>(json, '..invalid..path..', 'fallback')
        ...
        it('should handle non-existent nested paths', () => {
            ...
            const result = JsonHelper.Get<any>(json, 'level1.level2.level3.level4')
            expect(result).toBeUndefined()
        })
        ...
        it('should handle array indexing in path', () => {
            ...
            const result = JsonHelper.Get<string>(json, 'items[1]')
        ...
        it('should handle special characters in path', () => {
            ...
            const result = JsonHelper.Get<number>(json, '["special@key"].$value')
        ...
        it('should return undefined for existing path with undefined value', () => {
            ...
            const result = JsonHelper.Get<any>(json, 'prop')
            expect(result).toBeUndefined()
        })
        ...
        it('should get an array item', () => {
            ...
            const result = JsonHelper.Get<any>(json, 'data[1].name')
    ...
    describe('Set', () => {
        ...
        it('should update nested object property when valid jsonPath provided', () => {
            const json = { user: { name: 'John' } }
            const result = JsonHelper.Set(json, 'user.name', 'Jane')
        ...
        it('should replace entire json object when no jsonPath provided', () => {
            ...
            const result = JsonHelper.Set(json, undefined, newData)
        ...
        it('should update array element when numeric jsonPath provided', () => {
            const json = ['a', 'b', 'c']
            const result = JsonHelper.Set(json, '1', 'updated')
        ...
        it('should preserve original type when using generic type parameter', () => {
            ...
            const result = JsonHelper.Set<User>(json, 'age', 31)
        ...
        it('should throw errro if path undefined and data is not object', () => {
            const json = { prop: 'old' }
            try {
                JsonHelper.Set(json, undefined, 'new')
            } catch (error) {
                expect(error).toBeInstanceOf(HttpErrorInternalServerError)
            }
        })
        ...
        it('should return original json when data is undefined', () => {
            ...
            const result = JsonHelper.Set(json, 'test', undefined)
        ...
        it('should throw errro if path null and data is not object', () => {
            const json = { prop: 'old' }
            try {
                JsonHelper.Set(json, null as any, 'new')
            } catch (error) {
                expect(error).toBeInstanceOf(HttpErrorInternalServerError)
            }
        })
        ...
        it('should create new nested properties when invalid jsonPath provided', () => {
            const json = {}
            const result = JsonHelper.Set(json, 'a.b.c', 'value')
        ...
        it('should update array elements when array index path provided', () => {
            const json = { items: ['a', 'b', 'c'] }
            const result = JsonHelper.Set(json, 'items[1]', 'updated')
        ...
        it('should create intermediate objects when deep nested path provided', () => {
            const json = {}
            const result = JsonHelper.Set(json, 'deeply.nested.path', 'value')
            expect(result).toEqual({
                deeply: {
                    nested: {
                        path: 'value'
        ...
        it('should set an array item', () => {
            ...
            const result = JsonHelper.Set<any>(json, 'data[1].name', "New Item 2")
            expect(result).toEqual({
                data: [
                    {
                        id: 1,
