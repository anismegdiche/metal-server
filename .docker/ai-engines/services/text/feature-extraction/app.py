...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Feature extraction service utility")
    parser.add_argument("--load-pipe", action="store_true", help="Load the feature extraction pipeline and exit")
