...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Toxicity detection service utility")
    parser.add_argument("--load-pipe", action="store_true", help="Load the toxicity-detection pipeline and exit")
    args = parser.parse_args()
    
    if args.load_pipe:
        try:
            load_toxicity_pipeline()
